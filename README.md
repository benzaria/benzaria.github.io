...
## 🧑‍💻 About Me  
- My name is **Achraf Benzaria**, but everyone calls me **“Benz”**.  
- I’m a full-time **medical doctor** who also codes out of passion.  
- Skilled in **JavaScript, TypeScript, HTML/CSS, PowerShell, VB, VBS, Batch, Bash**.  
- I’m especially deep into **advanced TypeScript**, type-level systems, and creative utility types.  
- I play **basketball** and **chess**.  
- Huge fan of **RPG** and **Shooter** games.  
...
## 🩺 Medicine + Tech  
I love blending my medical background with programming — creating tools, automations, and workflows that enhance productivity, learning, and efficiency.
...
## 🚀 Let’s Connect  
Whether it’s **technology**, **medicine**, **TypeScript**, **chess**, or **gaming** — I’m always open to talking, collaborating, or exploring new ideas.
